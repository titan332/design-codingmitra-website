...
const pillars = [
  {
    ...
    cta: { label: "Hire Us", href: "#contact" },
  },
  {
    icon: Boxes,
        ...
        <Stagger className="mt-14 grid gap-6 lg:grid-cols-3">
          {pillars.map((p) => (
            <StaggerItem key={p.title}>
              <div className="group flex h-full flex-col rounded-2xl border border-border bg-card p-7 transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:shadow-xl">
